...
'''
Script para importar los datos de KNMI en el North Sea. La info sobre las cabeceras está en el fichero 'Data_Headers.csv'
...
if __name__ == "__main__":
    try:
        ...
        ruta_datos = ruta_actual / 'data' / 'Obs' / 'KNMI_NorthSea' / 'uurgeg_205_2011-2020.txt'
